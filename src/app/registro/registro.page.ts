...
export class RegistroPage implements OnInit {
  ...
  constructor(public modalController: ModalController, public fb: FormBuilder, private toastController:ToastController,
     private formularioService: FormularioService, private navController: NavController) {
  ...
  async enviarFormulario() {
    if (this.formularioRegistro.valid) {
      this.formularioService.setDatos(this.formularioRegistro.value);
